package com.rishavbanerjee.sat.assistant
...
import com.rishavbanerjee.sat.R
import com.rishavbanerjee.sat.data.AssistantDatabase
import com.rishavbanerjee.sat.databinding.ActivityAssistantBinding
...
class AssistantActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            cameraID =
                cameraManager.cameraIdList[0] // 0 is for back camera and 1 is for front camera
            ...
            override fun onResults(bundle: Bundle) {
                ...
                if (data != null) {
                    ...
                    when {
                        ...
                        keeper.contains("clear") || keeper.contains("clear the screen") || keeper.contains(
                            "clear everything"
                        ) -> assistantViewModel.onClear()
                        keeper.contains("date") || keeper.contains("what's the date today") || keeper.contains(
                            "what is the date today"
                        ) || keeper.contains("show me the date") || keeper.contains("show me the current date") -> getDate()
                        keeper.contains("time") || keeper.contains("what's the time now") || keeper.contains(
                            "show me the time"
                        ) || keeper.contains("show me the current time") -> getTime()
                        ...
                        keeper.contains("share a file") || keeper.contains("sharefile") -> shareAFile() // needs some work
                        keeper.contains("share a text message") || keeper.contains("share text message") -> shareATextMessage()
                        ...
                        keeper.contains("alarm") || keeper.contains("set an alarm") -> setAlarm()
                        keeper.contains("weather") || keeper.contains("how is the weather today") || keeper.contains(
                        ...
                        keeper.contains("hello") || keeper.contains("hi") || keeper.contains("hay") -> speak(
                            "Hello Sir, How can I  help you?"
                        )
                        keeper.contains("who created you") || keeper.contains("who is your creator") || keeper.contains(
                            "who developed you"
                        ) || keeper.contains("who built you") -> speak("I was Created by Rishav Banerjee")
                        keeper.contains("do you believe in God") -> speak("Yes, I do believe in God")
                        keeper.contains("who is your God") || keeper.contains("whose your god") -> speak(
                            "Rishav created me so definitely he is my absolute god"
                        )
                        keeper.contains("I love you") -> speak("That's awesome but I can't love you back because I don't have any emotions")
                        keeper.contains("do you love me") || keeper.contains("can you love me") -> speak(
                            "Yes I love you but as a friend"
                        )
                        keeper.contains("what is your gender") || keeper.contains("are you a boy or a girl") || keeper.contains(
                            "are you boy or girl"
                        ) -> speak("I'm beyond gender, I'm fluid")
                        keeper.contains("meaning of your name") || keeper.contains("what is the meaning of your name") || keeper.contains("full form of sat") || keeper.contains("meaning of sat") || keeper.contains("what is the meaning of sat") -> speak("This name Sat is inspired from World Famous MARVEL Comics characters.\n" +
                                "Tony Stark replaced JARVIS with FRIDAY due to JARVIS’ AI matrix being integrated with the Vibranium infused artificial body also known as The Vision. So basically SAT is abbreviated from the day name ‘Saturday’ , since my creator 'Rishav' was heavily inspired by Tony Stark and his assistant Friday, so he decided to call me SAT.\n")
                        keeper.contains("ok") || keeper.contains("okay") -> speak("I'm glad you understand")
                        keeper.contains("tell me something about your creator") || keeper.contains("who is rishav") || keeper.contains("tell me something about rishav") -> speak("Rishav Banerjee is a Computer Science Honours Student and he created me at the age of 22\n" +
                                "If you want to connect with him\n" +
                                "Instagram ID : rishav_is_live\n" +
                        "Website : rishavbanerjee.live")
                        else -> speak("This command does not exist in my brain")
                    }
                }
            }
...
//      on touch for fab
    ...
    // make a phone call to 9876543210
    ...
    // send sms to 9876543210 that message
    private fun sendSMS() {
        Log.d("keeper", "Done0")
        // runtime message
        if (ContextCompat.checkSelfPermission(
    ...
    fun clipBoardSpeak() {
        ...
        if (pasteData != "") {
            speak("Last Data stored in Clipboard is - $pasteData")
        } else {
    ...
    private fun horoscope() {
        ...
        val cGemini = HorologyController(object : Response {
            override fun onResponseObtained(zodiac: Zodiac) {
                val horoscope: String = zodiac.horoscope
                val sunsign: String = zodiac.sunSign
                val date: String = zodiac.date
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_ENABLE_BT) {
            if (resultCode == RESULT_OK) {
                ...
                speak("Couldn't turn on bluetooth")
            }
        }
